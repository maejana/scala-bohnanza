...
object gamedata {
  ...
  val selectPlantCard = "Gib ein welche Bohne du Pflanzen moechtest und in welches Feld Bsp: Sau 1: \n"
  ...
  val drawCardText = "Waehle welche Bohne du behaelst indem du den Namen der Bohne eingibst."
