...
object gamedata {
  ...
  val selectPlantCard = "Gib ein welche Bohne du Pflanzen möchtest Bsp: Sau: \n"
  ...
  val drawCardText = "Wähle wie viele Bohnen du selbst anpflanst indem du die Anzahl eingibst. z.B: 2"
